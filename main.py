...
def captionImage():
    ...
    if request.method == 'POST':
        ...
        if (not 'imgb64s' in data ):
            return "Please specify image base64 list (imgb64s)"
        
        b64s = data['imgb64s']
        try:
            imgs = [Image.open(BytesIO(base64.b64decode(b64))) for b64 in b64s]
        except Exception as e:
            return f"Error decoding images: {str(e)}"
